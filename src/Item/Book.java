...
public class Book extends item {
    ...
    public Book(String title, int copies, int borrowed, double isbn, String author, double pages, double cost, String type) {
    ...
    // EFFECTS: pages field is set to pages parameter
